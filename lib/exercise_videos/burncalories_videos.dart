...
class BurnCaloriesVideos extends StatefulWidget {
  const BurnCaloriesVideos({super.key});

  @override
  State<BurnCaloriesVideos> createState() => _BurnCaloriesVideosState();
}

class _BurnCaloriesVideosState extends State<BurnCaloriesVideos> {
